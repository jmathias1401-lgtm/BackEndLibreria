...
@Repository
@AllArgsConstructor
public class DetalleVentaRepository extends BaseRepository {
    private EntityManager entityManager;

    public Object list(DetalleVentaListRequest params, String mode) {
        Object response;
        CriteriaQuery query;
        ...
        List<String> likeFields = new ArrayList<String>() {{add("codigodetalleventa");}};
        ...
        if (params.getSearch() != null) {
            Predicate search = builder.like(
                    builder.upper(root.get("codigodetalleventa")),
