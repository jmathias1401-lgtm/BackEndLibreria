...
public class UsuarioRepository extends BaseRepository {
    ...
    public Object list(UserListRequest params, String mode) {
        Object response;
        CriteriaQuery query;
        List<Predicate> predicates = new ArrayList<>();
        Map mapParam = Util.dtoTomap(params);
        CriteriaBuilder builder = entityManager.getCriteriaBuilder();
        query = mode.equals("L") ? builder.createQuery(Usuario.class) : builder.createQuery(Long.class);
        ...
        List<String> eqFields = new ArrayList<String>() {{add("nombreusuario");add("idusuario");}};
        List<String> likeFields = new ArrayList<String>() {{add("nombreusuario");}};
        ...
        if (params.getSearch() != null) {
            Predicate search = builder.like(
                    builder.upper(root.get("nombreusuario")),
